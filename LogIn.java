...
public class LogIn extends JFrame implements ActionListener, Runnable {
    ...
    public LogIn() {
        ...
        txtAcctNo.setBorder(BorderFactory.createLineBorder(Color.BLUE));
        txtPIN.setBorder(BorderFactory.createLineBorder(Color.BLUE));
        ...
        pUpper.add(pLeft);
        pUpper.add(pRight);
        JLabel lbl1 = new JLabel("GAB_BANK", SwingConstants.CENTER);
